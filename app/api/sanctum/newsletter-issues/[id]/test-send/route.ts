...
const LOG_TAG = "NEWSLETTER ISSUE TEST SEND ERROR";

interface RouteParams {
  params: Promise<{ id: string }>;
}

// Sends the exact same branded email a real send would, to the admin inbox
// only — never touches sent_at/sent_count, and never reads
